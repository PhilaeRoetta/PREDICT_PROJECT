/*  The purpose of this table is calculate score, features and points for users
    ...
    Filter:
        Only user related with season on which the gameday is the action
    Materialization:
...
-- we calculate the total points, the number of predicted gamedays, and get the number of time the user came first
final_user as (
    SELECT
        ug2.USER_KEY,
        ug2.USER_NAME,
        ...
        COUNT(ug2.RANK_USER_GAMEDAY) AS NB_GAMEDAY_PREDICT,
        SUM(CASE 
