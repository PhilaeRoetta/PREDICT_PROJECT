/* The purpose of this table is to strictly copy data from curated_choice_bonus_check, on a incremental way
Will be run via Python program when it is manually decided in Python program input 
that curated_choice_bonus_check is ok */
{{config(
...
SELECT 
    * 
FROM 
    {{ref('curated_choice_bonus_check')}}
