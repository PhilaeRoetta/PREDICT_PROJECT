...
def copy_folder(remote_source_folder: str, remote_target_folder: str, sourcepath_from_root: Literal[0, 1] = 0, targetpath_from_root: Literal[0, 1] = 0, replace: Literal[0, 1] = 1):
    ...
    """
        ...
        Args:
            ...
            replace (0/1): If 1 we replace folder, else we just copy
        Raises:
...
def initiate_folder():
    ...
    copy_folder(config.DROPBOX_FOLDER_MAP['global_manual_inputs'],config.DROPBOX_FOLDER_MAP['manual_current'],sourcepath_from_root=1,targetpath_from_root=0, replace=0)
    copy_folder(config.DROPBOX_FOLDER_MAP['local_manual_inputs'],config.DROPBOX_FOLDER_MAP['manual_current'], replace=0)
