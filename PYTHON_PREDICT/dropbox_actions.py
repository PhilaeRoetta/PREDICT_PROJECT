...
def copy_folder(remote_source_folder: str, remote_target_folder: str, sourcepath_from_root: Literal[0, 1] = 0, targetpath_from_root: Literal[0, 1] = 0):
...
def initiate_folder():
    ...
    copy_folder(config.DROPBOX_FOLDER_MAP['global_manual_inputs'],config.DROPBOX_FOLDER_MAP['manual_current'],sourcepath_from_root=1,targetpath_from_root=0)
    copy_folder(config.DROPBOX_FOLDER_MAP['local_manual_inputs'],config.DROPBOX_FOLDER_MAP['manual_current'])
