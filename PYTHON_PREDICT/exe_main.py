...
def process_games(context_dict: dict) -> dict:
    ...
    context_dict['games_scope_id'] = gameA.get_list_games_from_need(context_dict['sr_snowflake_account_connect'], context_dict['sr_output_need'])          
    context_dict['df_game'] = gameA.extract_games(context_dict['games_scope_id']) 
